...
<div class="dash-content">
    <div class="activity">
        <div class="title">
            ...
            <span class="text">Add Report Maintenance</span>
        </div>


        <div class="container">
            <h2>Report Maintenance Data Form</h2>
            <form action="{{route('maintenance.store')}}" method='post'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="repair_status" required>
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="name" name="maintenance_date" required>
                </div>       
